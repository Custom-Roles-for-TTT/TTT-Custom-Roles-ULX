...
local revealbeg = xlib.makecheckbox { label = "ttt_reveal_beggar_change (def. 1)", repconvar = "rep_ttt_reveal_beggar_change", parent = indlst }
crproplst:AddItem(revealbeg)

local singdepimp = xlib.makecheckbox { label = "ttt_single_deputy_impersonator (def. 0)", repconvar = "rep_ttt_single_deputy_impersonator", parent = indlst }
...
local jestester = xlib.makecheckbox { label = "ttt_jesters_trigger_traitor_testers (def. 1)", repconvar = "rep_ttt_jesters_trigger_traitor_testers", parent = indlst }
crproplst:AddItem(jestester)

local indtester = xlib.makecheckbox { label = "ttt_independents_trigger_traitor_testers (def. 0)", repconvar = "rep_ttt_independents_trigger_traitor_testers", parent = indlst }
...
local echccs = xlib.makeslider { label = "ttt_hyp_credits_starting (def. 1)", min = 0, max = 10, repconvar = "rep_ttt_hyp_credits_starting", parent = ecoclst }
ecoclst:AddItem(echccs)
