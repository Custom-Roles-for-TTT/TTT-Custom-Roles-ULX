...
local function init()
    if GetConVar("gamemode"):GetString() == "terrortown" then --Only execute the following code if it's a terrortown gamemode
        ...
        CreateReplicatedWritableCvar("ttt_bodysnatcher_respawn")
        CreateReplicatedWritableCvar("ttt_bodysnatcher_respawn_limit")
        CreateReplicatedWritableCvar("ttt_bodysnatcher_respawn_delay")
        CreateReplicatedWritableCvar("ttt_bodysnatcher_notify_mode")
        CreateReplicatedWritableCvar("ttt_bodysnatcher_notify_sound")
        CreateReplicatedWritableCvar("ttt_bodysnatcher_notify_confetti")
        CreateReplicatedWritableCvar("ttt_bodysnatcher_device_time")
