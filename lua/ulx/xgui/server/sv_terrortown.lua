...
local function init()
    if GetConVarString("gamemode") == "terrortown" then --Only execute the following code if it's a terrortown gamemode
        ...
        ULib.replicatedWritableCvar("ttt_special_detective_pct", "rep_ttt_special_detective_pct", GetConVarNumber("ttt_special_detective_pct"), false, false, "xgui_gmsettings")
        ULib.replicatedWritableCvar("ttt_special_detective_chance", "rep_ttt_special_detective_chance", GetConVarNumber("ttt_special_detective_chance"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_assassin_target_vision_enable", "rep_ttt_assassin_target_vision_enable", GetConVarNumber("ttt_assassin_target_vision_enable"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_vampire_fang_dead_timer", "rep_ttt_vampire_fang_dead_timer", GetConVarNumber("ttt_vampire_fang_dead_timer"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_quack_fake_cure_mode", "rep_ttt_quack_fake_cure_mode", GetConVarNumber("ttt_quack_fake_cure_mode"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_parasite_infection_transfer", "rep_ttt_parasite_infection_transfer", GetConVarNumber("ttt_parasite_infection_transfer"), false, false, "xgui_gmsettings")
        ULib.replicatedWritableCvar("ttt_parasite_infection_transfer_reset", "rep_ttt_parasite_infection_transfer_reset", GetConVarNumber("ttt_parasite_infection_transfer_reset"), false, false, "xgui_gmsettings")
        ULib.replicatedWritableCvar("ttt_parasite_infection_suicide_mode", "rep_ttt_parasite_infection_suicide_mode", GetConVarNumber("ttt_parasite_infection_suicide_mode"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_all_search_binoc", "rep_ttt_all_search_binoc", GetConVarNumber("ttt_all_search_binoc"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_paladin_protect_self", "rep_ttt_paladin_protect_self", GetConVarNumber("ttt_paladin_protect_self"), false, false, "xgui_gmsettings")
        ULib.replicatedWritableCvar("ttt_paladin_heal_self", "rep_ttt_paladin_heal_self", GetConVarNumber("ttt_paladin_heal_self"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_clown_heal_bonus", "rep_ttt_clown_heal_bonus", GetConVarNumber("ttt_clown_heal_bonus"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_beggar_reveal_traitor", "rep_ttt_beggar_reveal_traitor", GetConVarNumber("ttt_beggar_reveal_traitor"), false, false, "xgui_gmsettings")
        ULib.replicatedWritableCvar("ttt_beggar_reveal_innocent", "rep_ttt_beggar_reveal_innocent", GetConVarNumber("ttt_beggar_reveal_innocent"), false, false, "xgui_gmsettings")
        ...
        ULib.replicatedWritableCvar("ttt_drunk_become_clown", "rep_ttt_drunk_become_clown", GetConVarNumber("ttt_drunk_become_clown"), false, false, "xgui_gmsettings")
        ULib.replicatedWritableCvar("ttt_drunk_notify_mode", "rep_ttt_drunk_notify_mode", GetConVarNumber("ttt_drunk_notify_mode"), false, false, "xgui_gmsettings")
