...
local function init()
    if GetConVar("gamemode"):GetString() == "terrortown" then --Only execute the following code if it's a terrortown gamemode
        ...
        CreateReplicatedWritableCvar("ttt_traitor_phantom_cure")
        ...
        CreateReplicatedWritableCvar("ttt_impersonator_activation_credits")
        CreateReplicatedWritableCvar("ttt_impersonator_detective_chance")
        CreateReplicatedWritableCvar("ttt_hypnotist_device_loadout")
        CreateReplicatedWritableCvar("ttt_hypnotist_device_shop")
        CreateReplicatedWritableCvar("ttt_hypnotist_device_shop_rebuyable")
        CreateReplicatedWritableCvar("ttt_hypnotist_convert_detectives")
        CreateReplicatedWritableCvar("ttt_hypnotist_device_time")
        ...
        CreateReplicatedWritableCvar("ttt_assassin_target_bonus_bought")
        ...
        CreateReplicatedWritableCvar("ttt_vampire_drain_credits")
        CreateReplicatedWritableCvar("ttt_vampire_kill_credits")
        CreateReplicatedWritableCvar("ttt_vampire_loot_credits")
        ...
        CreateReplicatedWritableCvar("ttt_vampire_fang_overheal_living")
        ...
        CreateReplicatedWritableCvar("ttt_quack_fake_cure_time")
        CreateReplicatedWritableCvar("ttt_quack_phantom_cure")
        CreateReplicatedWritableCvar("ttt_quack_station_bomb")
        CreateReplicatedWritableCvar("ttt_quack_station_bomb_time")
        ...
        CreateReplicatedWritableCvar("ttt_parasite_cure_time")
        ...
        CreateReplicatedWritableCvar("ttt_phantom_cure_time")
        ...
        CreateReplicatedWritableCvar("ttt_deputy_activation_credits")
        ...
        CreateReplicatedWritableCvar("ttt_veteran_activation_credits")
        CreateReplicatedWritableCvar("ttt_paramedic_device_loadout")
        CreateReplicatedWritableCvar("ttt_paramedic_device_shop")
        CreateReplicatedWritableCvar("ttt_paramedic_device_shop_rebuyable")
        CreateReplicatedWritableCvar("ttt_paramedic_defib_as_innocent")
        CreateReplicatedWritableCvar("ttt_paramedic_defib_time")
        ...
        CreateReplicatedWritableCvar("ttt_clown_use_traps_when_active")
        ...
        CreateReplicatedWritableCvar("ttt_beggar_respawn_limit")
        ...
        CreateReplicatedWritableCvar("ttt_lootgoblin_activation_timer_max")
        ...
        CreateReplicatedWritableCvar("ttt_lootgoblin_speed_mult")
        CreateReplicatedWritableCvar("ttt_lootgoblin_sprint_recovery")
        ...
        CreateReplicatedWritableCvar("ttt_killer_knife_damage")
        CreateReplicatedWritableCvar("ttt_killer_knife_delay")
        CreateReplicatedWritableCvar("ttt_killer_crowbar_enabled")
        CreateReplicatedWritableCvar("ttt_killer_crowbar_damage")
        CreateReplicatedWritableCvar("ttt_killer_crowbar_thrown_damage")
        ...
        CreateReplicatedWritableCvar("ttt_killer_update_scoreboard")
        ...
        CreateReplicatedWritableCvar("ttt_madscientist_device_time")
